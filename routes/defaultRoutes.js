...
router.route('/register')
    ...
    router.route('/registerEmail').post(defaultController.registerPostEmail);
...
router.route('/services')
    .get(defaultController.getServices)
   


    router.route('/mailAdmin')
    .post(defaultController.mailToAdmin)
